...
# approx_domain_length_x = 10e-3  # 10 mm converted to meters
# approx_domain_length_y = 5e-3   # 5 mm converted to meters
...
num_divisions_x = int( 10e-3  / grid_spacing_x)
num_divisions_y = int( 5e-3 / grid_spacing_y)
...
mesh  = refine_mesh_near_boundary( mesh, 0.5e-3, Domain )
mesh  = refine_mesh_near_boundary( mesh, 0.5e-3, Domain )


mesh  = refine_mesh_near_corners( mesh, 0.5e-3, Domain  )
...
file = fe.XDMFFile("Mar1.xdmf" ) # File Name To Save #
